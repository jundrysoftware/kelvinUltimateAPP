...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppServicesCategoryServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CategoryService = /*#__PURE__*/function () {
      function CategoryService(_methodsApiRestService) {
      ...
      _createClass(CategoryService, [{
        ...
        value: function categoryList() {
          ...
          this._methodsApiRestService.GetMethod('getAll_category_controller.php').subscribe(function (response) {
  ...
  function srcAppServicesDealsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DealsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], DealsService);
    /***/
  },
  ...
  function srcAppServicesMethodApiServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MethodApiServiceService = /*#__PURE__*/function () {
      function MethodApiServiceService(http) {
        ...
        this.domain = "http://localhost/kelvin/"; //Desarrollo
      }
    ...
    MethodApiServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
  ...
  function srcAppServicesProductsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProductsService = /*#__PURE__*/function () {
      function ProductsService(_methodsApiRestService) {
      ...
      _createClass(ProductsService, [{
        ...
        value: function productList() {
          ...
          this._methodsApiRestService.GetMethod('getAll_product_controller.php').subscribe(function (response) {
            if (typeof response[0] === 'undefined' || response[0] === null) {//swal.fire("Ups!", "Usuario no encontrado", "error");
            } else {
              for (var x in response) {
                var datos = {
        ...
        key: "productListByID",
        value: function productListByID(idpro) {
          var _this3 = this;

          this.products = [];

          this._methodsApiRestService.GetMethod('getAll_product_controller.php?id=' + idpro).subscribe(function (response) {
            if (typeof response[0] === 'undefined' || response[0] === null) {//swal.fire("Ups!", "Usuario no encontrado", "error");
            } else {
              for (var x in response) {
                var datos = {
