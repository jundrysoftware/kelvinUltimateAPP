...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["search-search-module"], {
  ...
  /***/
  function srcAppPagesSearchSearchComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesSearchSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_method_api_service_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../services/method-api-service.service */
    "./src/app/services/method-api-service.service.ts");

    var SearchComponent = /*#__PURE__*/function () {
      function SearchComponent(modalController, router, _methodsApiRestService) {
        _classCallCheck(this, SearchComponent);

        this.modalController = modalController;
        this.router = router;
        this._methodsApiRestService = _methodsApiRestService; // List of Products

        this.products = []; // Check is product available or not
      ...
      _createClass(SearchComponent, [{
        ...
        key: "getProductList",
        value: function getProductList(name) {
          var _this = this;

          this.products = [];

          this._methodsApiRestService.GetMethod('getAll_product_controller.php?like=' + name).subscribe(function (response) {
            if (typeof response[0] === 'undefined' || response[0] === null) {//swal.fire("Ups!", "Usuario no encontrado", "error");
            } else {
        ...
        key: "getProducts",
        value: function getProducts(ev) {
          // set val to the value of the searchbar
          var val = ev.target.value;
          this.getProductList(val); // if the value is an empty string don't filter the product
    ...
    SearchComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./src/app/pages/search/search.component.scss"))["default"]]
    })], SearchComponent);
    /***/
  },
  ...
  function srcAppPagesSearchSearchModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _search_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./search.component */
    "./src/app/pages/search/search.component.ts");
